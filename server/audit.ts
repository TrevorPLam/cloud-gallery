...
export enum AuditEventType {
  ...
  // SRP (Secure Remote Password) events
  SRP_REGISTER_SUCCESS = "SRP_REGISTER_SUCCESS",
  SRP_REGISTER_FAILURE = "SRP_REGISTER_FAILURE",
  SRP_CHALLENGE_SUCCESS = "SRP_CHALLENGE_SUCCESS",
  SRP_CHALLENGE_FAILURE = "SRP_CHALLENGE_FAILURE",
  SRP_VERIFY_SUCCESS = "SRP_VERIFY_SUCCESS",
  SRP_VERIFY_FAILURE = "SRP_VERIFY_FAILURE",
  SRP_SESSION_CLEANUP = "SRP_SESSION_CLEANUP",
  SRP_SUSPICIOUS_ACTIVITY = "SRP_SUSPICIOUS_ACTIVITY",
  SRP_SUSPICIOUS_ACTIVITY_BLOCKED = "SRP_SUSPICIOUS_ACTIVITY_BLOCKED",
  SRP_INVALID_REQUEST = "SRP_INVALID_REQUEST",
  SRP_HIGH_SESSION_COUNT = "SRP_HIGH_SESSION_COUNT",
  SRP_EXPIRED_SESSION_BACKLOG = "SRP_EXPIRED_SESSION_BACKLOG",
  SRP_EMERGENCY_CLEANUP = "SRP_EMERGENCY_CLEANUP",
