...
describe("SearchService", () => {
  ...
  describe("parseNaturalLanguageQuery", () => {
    ...
    it("should parse simple text query", () => {
      const result =
        searchService.parseNaturalLanguageQuery("beautiful sunset");
    ...
    it("should parse negation queries", () => {
      ...
      expect(result.negated?.objects).toEqual(
        expect.arrayContaining(["beach"]),
      );
      expect(result.photos).toBe(true);
      expect(result.negated?.locations).toEqual(
        expect.arrayContaining(["california"]),
      );
    });
  ...
  describe("generateSuggestions", () => {
    it("should generate suggestions for text queries", () => {
      ...
      const suggestions = (searchService as any).generateSuggestions(
        "beautiful sunset",
        searchQuery,
      );
