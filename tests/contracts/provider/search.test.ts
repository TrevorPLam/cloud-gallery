  ...
  const verifier = new Verifier({
    ...
    stateHandlers: {
      ...
      'user has no photos matching search query': async () => {
        console.log('Setting up state: user has no photos matching search query');
      ...
      'user has photos with matching text content': async () => {
        console.log('Setting up state: user has photos with matching text content');
        // Create test photos with matching OCR/text content
        return Promise.resolve();
      },
      'user has no photos with matching text content': async () => {
        console.log('Setting up state: user has no photos with matching text content');
