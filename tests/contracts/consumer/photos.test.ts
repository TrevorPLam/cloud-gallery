...
describe('Photos API Consumer Tests', () => {
  ...
  describe('GET /api/photos', () => {
    it('should return user photos with pagination', async () => {
      ...
      await provider.executeTest(async (mockServer) => {
        const response = await fetch(`${mockServer.url}/api/photos?limit=20&offset=0`, {
          method: 'GET',
          headers: authHeaders,
        });
    ...
    it('should return favorite photos only', async () => {
      ...
      await provider.executeTest(async (mockServer) => {
        const response = await fetch(`${mockServer.url}/api/photos?favorites=true&limit=10&offset=0`, {
          method: 'GET',
          headers: authHeaders,
        });
  ...
  describe('GET /api/photos/:id', () => {
    it('should return a specific photo', async () => {
      ...
      await provider.executeTest(async (mockServer) => {
        const response = await fetch(`${mockServer.url}/api/photos/${photoId}`, {
          method: 'GET',
          headers: authHeaders,
        });
    ...
    it('should return 404 for non-existent photo', async () => {
      ...
      await provider.executeTest(async (mockServer) => {
        const response = await fetch(`${mockServer.url}/api/photos/${nonExistentPhotoId}`, {
          method: 'GET',
          headers: authHeaders,
        });
  ...
  describe('PUT /api/photos/:id/favorite', () => {
    it('should toggle photo favorite status', async () => {
      ...
      await provider.executeTest(async (mockServer) => {
        const response = await fetch(`${mockServer.url}/api/photos/${photoId}/favorite`, {
          method: 'PUT',
          headers: authHeaders,
        });
    ...
    it('should return 404 when trying to favorite non-existent photo', async () => {
      ...
      await provider.executeTest(async (mockServer) => {
        const response = await fetch(`${mockServer.url}/api/photos/${nonExistentPhotoId}/favorite`, {
          method: 'PUT',
          headers: authHeaders,
        });
