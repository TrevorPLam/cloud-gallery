  ...
  describe('Loading and Data Display', () => {
    ...
    it('should display empty state when no duplicates found', async () => {
      ...
      await waitFor(() => {
        ...
        expect(screen.getByText('Your photo library looks clean! No duplicate photos were detected.')).toBeTruthy();
      });
    });
  ...
  describe('Duplicate Resolution', () => {
    ...
    it('should show confirmation dialog when resolving duplicates', async () => {
      ...
      expect(mockAlert).toHaveBeenCalledWith(
        'Resolve Duplicates',
        expect.stringContaining('Are you sure you want to resolve the selected duplicates?'),
        expect.any(Array)
      );
