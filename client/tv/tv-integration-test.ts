...
export const testTVVoiceSearch = async () => {
  ...
  try {
    ...
    for (const command of testCommands) {
      ...
      console.log(
        `✅ Command "${command}": ${isSupported ? "Supported" : "Not supported"}`,
      );
    }
...
export const testTVNavigation = () => {
  ...
  try {
    ...
    console.log(
      `✅ Platform detection: ${isTV ? "TV Platform" : "Mobile Platform"}`,
    );
...
export const verifyTVBuild = () => {
  ...
  console.log(
    `✅ TV build verification: ${passedChecks}/${totalChecks} checks passed`,
  );
